...
//get database connection
    ...
    //get category data from category table
    ...
    //get sub category data from sub category table
    ...
    <form id="item-form" class="form-horizontal col-lg-8 offset-lg-2" method="POST">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" id="inputitemcode" placeholder="Item Code" name="item_code" required>
                </div>
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" id="inpuname" placeholder="Item Name" name="item_name" required>
                </div>
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="number" class="form-control" id="inputquantity" placeholder="Quantity" name="quantity" required>
                </div>
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="number" class="form-control" id="inputunitprice" placeholder="Unit Price" name="unit_price" required>
                </div>
            </div>
            <br>
